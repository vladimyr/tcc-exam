import AssessmentItem$1 from 'client/components/editor/structure/AssessmentItem';
import find from 'lodash/find';
import get from 'lodash/get';
import Multiselect from 'client/components/common/Select';
  ...
  computed: {
    introductionElements: function introductionElements() {
      ...
      var cond = function cond(it) {
        return it.activityId === group.id && !isQuestion(it.type);
      };
...
var script$2 = {
  ...
  computed: {
    ...
    objectiveLabel: function objectiveLabel() {
      ...
      var label = types.length > 1 ? 'Objective' : getLevel(types[0]).label;
