...
var AssessmentItem$1 = _interopDefault(require('client/components/editor/structure/AssessmentItem'));
var find = _interopDefault(require('lodash/find'));
var get = _interopDefault(require('lodash/get'));
var Multiselect = _interopDefault(require('client/components/common/Select'));
...
var activities = require('shared/activities');
var utils = require('tce-core/utils');
var sortBy = _interopDefault(require('lodash/sortBy'));
var isEmpty = _interopDefault(require('lodash/isEmpty'));
var map = _interopDefault(require('lodash/map'));
var numberToLetter = _interopDefault(require('utils/numberToLetter'));
...
var script = {
  ...
  created: function created() {
    var objectiveId = get(this.assessment, 'refs.objectiveId');
    if (!objectiveId) return;
    this.objective = find(this.objectives, {
      id: objectiveId
    });
  },
  components: {
...
var script$2 = {
  ...
  computed: {
    ...
    objectiveLabel: function objectiveLabel() {
      ...
      var types = uniq(map(this.objectives, 'type'));
  ...
  watch: {
    ...
    timeLimit: debounce(function (val) {
      ...
      this.$validator.validateAll().then(function (isValid) {
        if (!isValid) return;
        var group = cloneDeep(_this.group);
...
var script$3 = {
  ...
  computed: {
    ...
    examObjectives: function examObjectives() {
      ...
      var activity$1 = find(activities, {
        id: container.parentId
      });
      var objectiveTypes = get(config, 'objectives');
